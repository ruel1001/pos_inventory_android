...
@AndroidEntryPoint
class ProfitListFragment : Fragment(), CustomerNamesAdapter.ArticleCallback {
    ...
    private fun setupPaymentList() = binding.run {
        ...
        customerNamesAdapter = CustomerNamesAdapter(requireActivity(), this@ProfitListFragment)
    ...
    companion object {
        ...
        fun getIntent(context: Context): Intent {
            return Intent(context, ProfitListFragment::class.java)
        }
