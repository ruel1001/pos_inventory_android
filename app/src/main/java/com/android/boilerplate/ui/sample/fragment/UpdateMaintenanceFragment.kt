...
import com.android.boilerplate.databinding.FragmentUpdateMaintenanceBinding
...
@AndroidEntryPoint
class UpdateMaintenanceFragment : Fragment() {
    private var _binding: FragmentUpdateMaintenanceBinding? = null
    private val binding get() = _binding!!
    private val viewModel: CreateMaintenanceViewModel by viewModels()
    private var loadingDialog: CommonDialog? = null

    private val args: UpdateMaintenanceFragmentArgs by this.navArgs()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentUpdateMaintenanceBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    private fun setDataDisplay() = binding.run {
        ...
        areaEditText.setText(args?.area)
        natureOfRepairEditText.setText(args?.natureOfRepair)
        materialUsedEditText.setText(args?.materialUsed)
    ...
    private fun setClickListener() = binding.run {
        deleteButton.setOnSingleClickListener {
            ...
            alertDialogBuilder.apply {
                ...
                setPositiveButton("Delete") { _, _ ->
                    viewModel.doRemoveMainteanance(args.maintenanceId)
                }
        ...
        saveButton.setOnSingleClickListener {
                ...
                var materialListDialog =
                    MaterialListDialog.newInstance(object : MaterialListDialog.ApproveCallBack {
                        ...
                        override fun onSuccess(
                            ...
                            materialUsedEditText.setText(itemName.toString())
                            materialID = itemID
                        }
                    })
            ...
            if (materialUsedEditText.text.toString()
                    .isNotEmpty() && natureOfRepairEditText.text.toString().isNotEmpty()
            ) {


                viewModel.doUpdateMaintenance(
                    args.maintenanceId,
    ...
    private fun bluprint(data: SearchMaintenanceResponse.MaintenanceSearchData?) {
        if (nowprint) {
            ...
            printer.printTextNormalHeader("\nArea  " +  args.area)
            printer.printTextNormalHeader("\nMaterial Used:  " +  args.materialUsed)
            printer.printTextNormalHeader("\nNature of Repair:  " +  args.natureOfRepair)
            printer.printTextNormalHeader("\nQuantity Used:  " +  args.quantity)
            printer.printTextNormalHeader("\nThank you for choosing us\n\n\n\n" )
        }
    }
    ...
    companion object {
        ...
        fun getIntent(context: Context): Intent {
            return Intent(context, UpdateMaintenanceFragment::class.java)
        }
