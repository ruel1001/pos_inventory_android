...
import com.android.boilerplate.databinding.DialogMaintenanceBinding
...
@AndroidEntryPoint
class MaintenanceDialog : DialogFragment() {

    private var viewBinding: DialogMaintenanceBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewBinding = DialogMaintenanceBinding.bind(view)
        setClickListener()
    ...
    private fun setClickListener() {
        ...
        viewBinding?.salesLinearLayout?.setOnSingleClickListener {
    ...
    companion object {
        ...
        fun newInstance(callback: ApproveCallBack? = null) = MaintenanceDialog()
            .apply {
                this.callback = callback

            }

        val TAG: String = MaintenanceDialog::class.java.simpleName
    }
}